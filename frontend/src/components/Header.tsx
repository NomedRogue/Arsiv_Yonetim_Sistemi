...
export const Header: React.FC<HeaderProps> = ({ pageTitle, theme, toggleTheme, toggleSidebar }) => {
  return (
    <header className="bg-white dark:bg-archive-dark-panel p-4 flex justify-between items-center shadow-md sticky top-0 z-20 h-[69px] transition-colors duration-300">
